  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark header-back sticky-top header-navbar-fonts">
      <a class="navbar-brand d-flex align-items-center" href="../index.php">
        ...
        <h4 class="text-light text-uppercase ml-2">University Srimad Rambhapuri College of Arts & Commerce</h4>
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item active">
            <a class="nav-link" href="../website/index.html">HOME<span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item active">
            <a class="nav-link" href="../website/about.html">ACADEMICS<span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item active">
