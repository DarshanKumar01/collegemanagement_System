        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="../admin/Student.php">
              ...
              <i class="fa fa-user-circle mr-2" aria-hidden="true"></i> Student             </a>
          </li>
		   <li class="nav-item">
            <a class="nav-link" href="../admin/Student1.php">
              <span data-feather="shopping-cart"></span>
              <i class="fa fa-user-circle mr-2" aria-hidden="true"></i> Online Student Registration
            </a>
          </li>
          <li class="nav-item">
