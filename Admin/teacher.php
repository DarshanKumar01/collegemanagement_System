...
// *****************************************Images upload code end here********************************************************** 
 		...
 		$query="Insert into teacher_info(first_name,middle_name,last_name,email,phone_no,profile_image,teacher_status,application_status,cnic,dob,other_phone,gender,permanent_address,current_address,place_of_birth,matric_complition_date,matric_awarded_date,fa_complition_date,fa_awarded_date,ba_complition_date,ba_awarded_date,ma_complition_date,ma_awarded_date,hire_date)values('$first_name','$middle_name','$last_name','$email','$phone_no','$profile_image','$teacher_status','$application_status','$cnic','$dob','$other_phone','$gender','$permanent_address','$current_address','$place_of_birth','$matric_complition_date','$matric_awarded_date','$fa_complition_date','$fa_awarded_date','$ba_complition_date','$ba_awarded_date','$ma_complition_date','$ma_awarded_date','$date')";
											...
											<div class="row">
												...
												<div class="col-md-4">
													<div class="formp">
														...
														<input type="tel" name="phone_no" class="form-control"  pattern="[6-9]{1}[0-9]{9}" 
											...
											<div class="row">
												...
												<div class="col-md-4">
													<div class="formp">
														...
														<input type="text" name="cnic" class="form-control" placeholder="Cnic No" required>
													</div>
												</div>
											</div>
											<div class="row">
												...
												<div class="col-md-4">
													<div class="formp">
														...
														<input type="text" name="current_address" class="form-control" placeholder="Enter Current Address" required>
															<input type="hidden" name="place_of_birth" class="form-control" placeholder="Enter Place of Birth">
															<input type="hidden" name="matric_complition_date" class="form-control">
															<input type="hidden" name="matric_awarded_date" class="form-control">
															<input type="hidden" name="matric_certificate" class="form-control">
															<input type="hidden" name="fa_complition_date" class="form-control">
															<input type="hidden" name="fa_awarded_date" class="form-control">
															<input type="hidden" name="fa_certificate" class="form-control">
															<input type="hidden" name="ba_complition_date" class="form-control">
															<input type="hidden" name="ba_awarded_date" class="form-control">
															<input type="hidden" name="ba_certificate" class="form-control">
															<input type="hidden" name="ma_complition_date" class="form-control">
															<input type="hidden" name="ma_awarded_date" class="form-control"><input type="hidden" name="ma_certificate" class="form-control">
													</div>
												</div>
															...
															<div class="col-md-6">
																<div class="form-group">
																	...
																	<select class="browser-default custom-select" name="course_code" required="">
																		...
																		<?php
																			$query="select distinct(course_code), course_name from courses";
																			$run=mysqli_query($con,$query);
