					...
					<div class="col-md-12 ml-2">
						<section class="mt-3">
							...
							<table class="w-100 table-elements mb-5 table-three-tr text-center" cellpadding="10">
								...
								<?php 
								$query="select first_name,middle_name,admission_date,last_name,current_address,session,roll_no,form_b ,profile_image,course_code from student_info where admission_from ='1' order by roll_no desc";
								$run=mysqli_query($con,$query);
									...
									<tr>
										...
										<td width='170'> 
											<?php 
												...
												<a class='btn btn-warning' href=student-approved.php?roll_no=".$row['roll_no'].">Approved</a> <br/>
